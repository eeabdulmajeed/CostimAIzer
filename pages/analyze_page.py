...
# ملاحظات هامة للمطور:
# هذا الملف مخصص لصفحة تحليل الأسعار فقط. يحتوي على الركائز الأساسية (OpenAI، NLP، التفاعل بين النماذج).
    ...
    for discrepancy in discrepancies:
        if "غير منطقي" in discrepancy:
            ...
            try:
                ...
                reasoning.append(f"تم التحكيم: أعيد تقدير سعر '{item}' إلى ${new_price:,.2f} بن
